...
useEffect(() => {
  ...
  return (
    <section className='bg-white text-black h-52 md:h-[450px] flex items-start place-content-center flex-col px-[10%]'>
       <h1 className={withManropeLeft} data-replace='{"-translate-x-[120%]": "translate-x-0", "-translate-y-10": "translate-y-0"}'>Beautiful websites that</h1>
       <p className={withManropeRight} data-replace='{"translate-x-[120%]": "translate-x-0", "translate-y-10": "translate-y-0"}'>bring customers to your door</p>
    </section>
  )
}
